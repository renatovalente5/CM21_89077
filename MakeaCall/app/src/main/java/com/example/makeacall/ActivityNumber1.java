...
public class ActivityNumber1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveNum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MainActivity.number1 = phoneNo.getText().toString();
                Intent i = new Intent(ActivityNumber1.this,MainActivity.class);
                startActivity(i);
